...
const ctx = gsap.context(() => {
  ...
  /*
   * =======================================================
   * IMPORTANT SLIDER CALCULATION
   * =======================================================
   *
   * 6 services = 5 movements
   * 10 services = 9 movements
   *
   * Every movement is exactly ONE viewport width.
   */

  const transitionCount = Math.max(serviceCount - 1, 0);
  ...
  const sliderTimeline = gsap.timeline({
    scrollTrigger: {
       ...
       */
        ...
        `+=${window.innerWidth * transitionCount}`,
   ...
   *
   * Track itself is N × viewport wide.
   * Therefore we move it using exact pixels.
   */
...
return (
<section ref={sectionRef} className="relative z-30 h-screen overflow-hidden bg-[#050505] text-white" >
{/* CURSOR GLOW */}
